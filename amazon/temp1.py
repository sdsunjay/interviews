...
if __name__ == '__main__':
    # Input 1
    n1 = 5
    city1 = [[12, 0, 0, 0, 8], [12, 0, 1, 0, 0], [0, 1, 0, 30, 0],
             [0, 0, 0, 30, 1], [12, 0, 0, 1, 0]]
    # findcost(n1, city1)
    # Input 2
    n2 = 6
    city2 = [[0, 1, 1, 100, 0, 0], [1, 0, 1, 0, 0, 0], [1, 1, 0, 0, 0, 0],
             [100, 0, 0, 0, 2, 2], [0, 0, 0, 2, 0, 2], [0, 0, 0, 2, 2, 0]]
    findcost(n2, city2)  # This code is contributed by PranchalK [tabbyending]
